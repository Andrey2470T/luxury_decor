luxury_decor.register_light({
	actual_name = "luxury_desk_lamp",
	type = "lantern",
	style = "luxury",
	mesh = "luxury_desk_lamp.b3d",
	textures = {"luxury_decor_luxury_desk_lamp.png"},
	groups = {choppy = 2.5},
	toggleable = true,
	light_source = 7,
	drop_on = "luxury_decor:luxury_desk_lamp_off",
	inventory_image = "luxury_decor_luxury_desk_lamp_inv.png",
	craft_recipe = {
...
--[[minetest.register_node("luxury_decor:luxury_desk_lamp_off", {
    ...
    mesh = "luxury_desk_lamp.b3d",
    inventory_image = "luxury_decor_luxury_desk_lamp_inv.png",
    tiles = {"luxury_decor_luxury_desk_lamp.png"},
    paramtype = "light",
    paramtype2 = "facedir",
    groups = {choppy = 2.5},
    drawtype = "mesh",
...
luxury_decor.register_light({
	actual_name = "iron_chandelier",
	type = "chandelier",
	style = "luxury",
	material = "steel",
	mesh = "iron_chandelier.obj",
	inventory_image = "luxury_decor_iron_chandelier_inv.png",
	textures = {
		{
            name = "luxury_decor_iron_chandelier_animated.png",
...
luxury_decor.register_light({
	actual_name = "wall_glass_lamp",
	type = "lantern",
	style = "luxury",
	material = "wooden",
	mesh = "wall_glass_lamp.b3d",
	textures = {"luxury_decor_wall_glass_lamp.png"},
	inventory_image = "luxury_decor_wall_glass_lamp_inv.png",
	toggleable = true,
	drop_on = "luxury_decor:wall_glass_lamp_off",
	craft_recipe = {
...
--[[minetest.register_node("luxury_decor:wall_glass_lamp_off", {
    ...
    mesh = "wall_glass_lamp.b3d",
    inventory_image = "luxury_decor_wall_glass_lamp_inv.png",
    tiles = {"luxury_decor_wall_glass_lamp.png"},
    paramtype = "light",
    paramtype2 = "facedir",
    groups = {choppy = 2.5},
    drawtype = "mesh",
...
luxury_decor.register_light({
	actual_name = "royal_brass_chandelier",
	type = "chandelier",
	style = "royal",
	material = "brass",
	base_color = "khaki",
	mesh = "royal_brass_chandelier.b3d",
	textures = {"luxury_decor_royal_brass_chandelier.png"},
	inventory_image = "luxury_decor_royal_brass_chandelier_inv.png",
	collision_box = {
		{-0.4, -0.5, -0.4, 0.4, 0.5, 0.4},
		{-1.1, -1.5, -1.1, 1.1, -0.5, 1.1}
	},
	toggleable = true,
	drop_on = "luxury_decor:royal_brass_chandelier_off",
	craft_recipe = {
...
--[[minetest.register_node("luxury_decor:royal_brass_chandelier_off", {
    ...
    inventory_image = "luxury_decor_royal_brass_chandelier_inv.png",
    tiles = {"luxury_decor_royal_brass_chandelier.png"},
    paramtype = "light",
    paramtype2 = "facedir",
    groups = {choppy = 2.5},
    drawtype = "mesh",
...
luxury_decor.register_light({
	actual_name = "luxury_steel_chandelier",
	type = "chandelier",
	style = "luxury",
	material = "steel",
	base_color = "grey",
	mesh = "luxury_steel_chandelier.b3d",
	textures = {"luxury_decor_luxury_steel_chandelier.png"},
	inventory_image = "luxury_decor_luxury_steel_chandelier_inv.png",
	groups = {snappy = 2.5},
	collision_box = {
	...
	drop_on = "luxury_decor:luxury_steel_chandelier_off",
	craft_recipe = {
...
--[[minetest.register_node("luxury_decor:luxury_steel_chandelier_off", {
    ...
    use_texture_alpha = true,
    inventory_image = "luxury_decor_luxury_steel_chandelier_inv.png",
    tiles = {"luxury_decor_luxury_steel_chandelier.png"},
    paramtype = "light",
    paramtype2 = "facedir",
    groups = {snappy = 2.5},
    drawtype = "mesh",
...
luxury_decor.register_light({
	actual_name = "simple_plastic_chandelier",
	type = "chandelier",
	material = "plastic",
	...
	paintable = true,
	drop_on = "luxury_decor:simple_plastic_chandelier_off",
	craft_recipe = {
        output = "luxury_decor:simple_plastic_chandelier_off",
        recipe = {
            {"luxury_decor:plastic_sheet", "luxury_decor:plastic_sheet", "luxury_decor:wooden_plank"},
            {"luxury_decor:plastic_sheet", "dye:white", "luxury_decor:lampshades"},
            {"luxury_decor:incandescent_bulbs", "", ""}
        }
   }
})
...
luxury_decor.register_light({
	...
	light_source = minetest.LIGHT_MAX - 2,
	paintable = true,
	drop_on = "luxury_decor:plastic_desk_lamp_off",
	craft_recipe = {
        output = "luxury_decor:plastic_desk_lamp_off",
        recipe = {
            {"luxury_decor:plastic_sheet", "luxury_decor:brass_stick", "luxury_decor:brass_stick"},
            {"luxury_decor:plastic_sheet", "dye:white", "luxury_decor:lampshade"},
...
--[[for color, rgb_code in pairs(luxury_decor.rgb_colors) do
   minetest.register_node("luxury_decor:simple_plastic_"..color.."_chandelier_off", {
    ...
    mesh = "simple_plastic_chandelier.b3d",
    use_texture_alpha = true,
    tiles = {"luxury_decor_simple_plastic_chandelier.png^(luxury_decor_simple_plastic_chandelier_2_1.png^[colorize:"..rgb_code.."^luxury_decor_simple_plastic_chandelier_2.png)"},
    paramtype = "light",
    paramtype2 = "facedir",
    groups = {snappy = 1.5},
    drawtype = "mesh",
   ...
   minetest.register_node("luxury_decor:plastic_"..color.."_desk_lamp_off", {
    ...
    mesh = "plastic_desk_lamp.b3d",
    use_texture_alpha = true,
    tiles = {"luxury_decor_plastic_desk_lamp.png^(luxury_decor_plastic_desk_lamp_2_1.png^[colorize:"..rgb_code.."^luxury_decor_plastic_desk_lamp_2.png)"},
    paramtype = "light",
    paramtype2 = "facedir",
    groups = {snappy = 1.5},
    drawtype = "mesh",
...
luxury_decor.register_light({
	actual_name = "luxury_brass_candlestick",
	type = "candlestick",
	style = "luxury",
	material = "brass",
...
luxury_decor.register_light({
	actual_name = "luxury_brass_triple_candlestick",
	type = "candlestick",
	style = "luxury",
	material = "brass",
...
luxury_decor.register_light({
	actual_name = "ceiling_lantern",
	style = "luxury",
	material = "plastic",
	base_color = "black",
	mesh = "ceiling_lantern.b3d",
	textures = {"luxury_decor_street_lantern.png"},
	collision_box = {
...
--[[minetest.register_node("luxury_decor:ceiling_lantern", {
    ...
    tiles = {"luxury_decor_street_lantern.png"},
    paramtype = "light",
    paramtype2 = "facedir",
    groups = {snappy = 1.5},
    drawtype = "mesh",
